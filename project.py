...
import glob
txtfiles = [] 
for file in glob.glob("mano.jpg"):
...
for ix in txtfiles:
    ...
    facecascade = cv2.CascadeClassifier('C:\\project\\haarcascade_frontalface_default.xml')
    eye_cascade = cv2.CascadeClassifier('C:\\project\\haarcascade_eye.xml')
